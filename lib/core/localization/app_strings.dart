...
class AppStrings {
  ...
  static String translateFeature(String label) {
    final map = {
      ...
      'Работа с возражениями': {AppLanguage.en: 'Handling Objections', AppLanguage.ar: 'التعامل со встречными предложениями'},
  ...
  String get paySuccessBody => _map({AppLanguage.ru: 'Подписка активирована (тестовый режим)', AppLanguage.en: 'Subscription activated (test mode)', AppLanguage.ar: 'تم تفعيل الاشتراك'});
  String get payContinue => _map({AppLanguage.ru: 'Продолжить', AppLanguage.en: 'Continue', AppLanguage.ar: 'استمرار'});

  // --- Подключение бота ---
  String get connStep1Title => _map({AppLanguage.ru: 'Шаг 1: Подключение Telegram', AppLanguage.en: 'Step 1: Telegram Connection', AppLanguage.ar: 'الخطوة ١'});
  String get connStep2Title => _map({AppLanguage.ru: 'Шаг 2: Настройка сервера', AppLanguage.en: 'Step 2: Server Setup', AppLanguage.ar: 'الخطوة ٢'});
  ...
  String get connErrorNoToken => _map({AppLanguage.ru: 'Пожалуйста, введите токен Telegram', AppLanguage.en: 'Please enter Telegram token', AppLanguage.ar: 'يرجى إدخال الرمز'});
  ...
  String get connRailwayInstrBody => _map({
    AppLanguage.ru: '1. Войдите в Railway.\n2. Создайте API Token.\n3. Скопируйте Workspace ID.',
    AppLanguage.en: '1. Log in to Railway.\n2. Create an API Token.\n3. Copy Workspace ID.',
    AppLanguage.ar: '١. سجل في Railway.\n٢. أنشئ رمز API.\n٣. انسخ معرف مساحة العمل.'
  });
  String get connRailwayTokenLabel => _map({AppLanguage.ru: 'RAILWAY API ТОКЕН', AppLanguage.en: 'RAILWAY API TOKEN', AppLanguage.ar: 'رمز Railway'});
  ...
  String get connErrorNoRailway => _map({AppLanguage.ru: 'Пожалуйста, заполните данные Railway', AppLanguage.en: 'Please fill Railway data', AppLanguage.ar: 'يرجى ملء البيانات'});
  String get connSuccessDeploy => _map({AppLanguage.ru: 'Бот успешно отправлен на деплой!', AppLanguage.en: 'Bot sent for deployment!', AppLanguage.ar: 'تم إرسال البوت للنشر!'});
  ...
  String get myBotsEmpty => _map({AppLanguage.ru: 'У вас пока нет подключённых ботов', AppLanguage.en: 'You have no connected bots yet', AppLanguage.ar: 'ليس لديك بوتات متصلة'});
  ...
  String get profPassLength => _map({AppLanguage.ru: 'Пароль должен быть минимум 6 символов', AppLanguage.en: 'Min 6 chars', AppLanguage.ar: '٦ أحرف على الأقل'});
  String get profPassSuccess => _map({AppLanguage.ru: 'Пароль успешно изменён', AppLanguage.en: 'Password changed', AppLanguage.ar: 'تم تغيير كلمة المرور'});

  // --- Уведомления ---
  String get notifPush => _map({AppLanguage.ru: 'Push-уведомления', AppLanguage.en: 'Push notifications', AppLanguage.ar: 'إشعارات'});
  String get notifPushSub => _map({AppLanguage.ru: 'Получать уведомления на устройство', AppLanguage.en: 'On device', AppLanguage.ar: 'على الجهاز'});
  ...
  String get notifEmailSub => _map({AppLanguage.ru: 'Получать уведомления на почту', AppLanguage.en: 'By email', AppLanguage.ar: 'عبر البريد'});
  ...
  String get bmReady => _map({AppLanguage.ru: 'Бот готов к приему заказов', AppLanguage.en: 'Bot ready', AppLanguage.ar: 'البوت جاهز'});
  String get bmBindGroup => _map({AppLanguage.ru: 'Привяжите Telegram группу', AppLanguage.en: 'Bind group', AppLanguage.ar: 'ربط المجموعة'});
